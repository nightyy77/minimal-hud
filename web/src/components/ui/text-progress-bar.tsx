...
export const TextProgressBar = ({ value = 50, label = "FUEL", color = "#06CE6B", ...props }: TextProgressBarProps) => {
  ...
  return (
    <div className={"flex flex-col items-center justify-center w-[2.5dvw] h-[4dvh] -skew-x-[10deg]"} {...props}>
      <h1 className={"uppercase text-[0.8vw] font-geist drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)] font-bold"}>{label}</h1>
